...
async function defaultHome(model){
 ...
 * @param { object } document the new mongodb document, it's mean a register
 */
async function create(model, document){
...
module.exports = { create, read, del, defaultHome}